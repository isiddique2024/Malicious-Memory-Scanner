...
#define fn(name) ::li::detail::lazy_function<LAZY_IMPORTER_KHASH(#name), decltype(&name)>()

#define fn_def(name) ::li::detail::lazy_function<LAZY_IMPORTER_KHASH(#name), name>()

#define fn_mod(name) ::li::detail::lazy_module<LAZY_IMPORTER_KHASH(name)>()
//#define LAZY_IMPORTER_RESOLVE_FORWARDED_EXPORTS true
...
#define LAZY_IMPORTER_CASE_SENSITIVITY false // remove if issues
